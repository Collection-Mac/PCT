        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="service1.php" class="nav-item nav-link">Electricité</a>
                    <a href="service2.php" class="nav-item nav-link">Plomberie</a>
                    <a href="service3.php" class="nav-item nav-link active">Ménuisérie</a>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <div class="section-title border-right-0 mb-0" style="width: 100%; background: #430243;">
                            <h4 class="m-0 text-uppercase font-weight-bold" style="color: #fff;">Menuisiers & ébénistes</h4>
                        </div>
                    </div>
                </div>
            </div>
