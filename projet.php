        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="projet.php" class="nav-item nav-link active">Projets Mairie & ...</a>
        ...
        <div class="row news-lg mx-0 mb-3">
            <div class="col-md-6 d-flex flex-column border bg-white h-100 px-0" style="color: #111111;">
                <div class="p-4">
                    ...
                    <p class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="">Construction de pont</p>
                    <p class="m-0">quelques détails du projet <br>
                        rebum clita rebum dolor stet amet justo</p>
                </div>
            </div>
            <div class="col-md-6 h-100 px-0">
                <img class="img-fluid h-100" src="img/actu-2.jpg" style="object-fit: cover;">
            </div>
        </div>
        ...
        <div class="row py-4">
            ...
            <div class="col-md-6">
                ...
                <div class="m-n1">
                    ...
                    <a href="" class="btn btn-sm btn-secondary m-1">Offres emplois</a>
