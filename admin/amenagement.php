...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["amenagement_submit"])) {
        ...
        if ($conn->query($sqlAmenagement) === true) {
            echo "--------------------------------------------------------------ENREGISTREMENT D'AMENAGEMENT REUSSI !";
        } else {
            echo "--------------------------------------------------------------Une erreur s'est produite lors de l'enregistrement d'aménagement : " . $conn->error;
        }
    }
}
...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="amenagement.php" class="dropdown-item active">Aménagements</a>
        ...
        <div class="content">
            ...
            <!-- Debut Liste AMENAGEMENT -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">AMENAGEMENT</h6>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Mode d'hébergement</th>
            ...
            <!-- Fin Liste AMENAGEMENT -->


            <!-- Debut Form AMENAGEMENT -->
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Ajouter un aménagement</h6>
                            <form method="POST" action="">
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="noma" class="form-control" id="nomPharm" placeholder="Nom & Prénoms" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="sexea" class="form-control" id="nomPharm" placeholder="Sexe" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="fonctiona" class="form-control" id="nomPharm" placeholder="Fonction" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="nomPharm" class="col-form-label">Date de naissance</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="datea" class="form-control" id="nomPharm" placeholder="Date de naissance" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="provenancea" class="form-control" id="nomPharm" placeholder="Provenance" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="modea" class="form-control" id="nomPharm" placeholder="Mode d'hébergement" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="lieua" class="form-control" id="nomPharm" placeholder="Lieu d'habitation de la famille" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="tela" class="form-control" id="nomPharm" placeholder="Numéro" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="whatsappa" class="form-control" id="nomPharm" placeholder="Numéro Whatsapp" autocomplete="none" >
                                    </div>
                                </div>
                                <button type="submit" name="amenagement_submit" class="btn btn-outline-primary m-2">Ajouter</button>
                            </form>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Fin Form AMENAGEMENT -->
