...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Vérifie si l'utilisateur à cliquer sur "SUBMIT" du formulaire deces
    if (isset($_POST["deces_submit"])) {
        ...
        if ($conn->query($sqlDeces) === true) {
            echo "--------------------------------------------------------------ENREGISTREMENT DECES REUSSI !";
        } else {
            echo "--------------------------------------------------------------Une erreur s'est produite lors de l'enregistrement de décès : " . $conn->error;
        }
    }
}
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="deces.php" class="dropdown-item active">Décès</a>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Mode de décès</th>
                                    <th scope="col">Raison du décès</th>
                                    <th scope="col">Nom du référent</th>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Ajouter un décès</h6>
                            <form method="POST" action="">
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="nomd" class="form-control" id="nomPharm" placeholder="Nom & Prénoms" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="sexed" class="form-control" id="nomPharm" placeholder="Sexe" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="fonctiond" class="form-control" id="nomPharm" placeholder="Fonction" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="nomPharm" class="col-form-label">Date de naissance</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="datenaissanced" class="form-control" id="nomPharm" placeholder="Date de naissance" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="nomPharm" class="col-form-label">Date de décès</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="dated" class="form-control" id="nomPharm" placeholder="" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="moded" class="form-control" id="nomPharm" placeholder="mode de décès" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="raisond" class="form-control" id="nomPharm" placeholder="Raison du décès" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="nomreferentd" class="form-control" id="nomPharm" placeholder="Nom du référent" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="lieud" class="form-control" id="nomPharm" placeholder="Lieu d'habitation de la famille" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="teld" class="form-control" id="nomPharm" placeholder="Numéro" autocomplete="none" >
                                    </div>
                                </div>
                                <button type="submit" name="deces_submit" class="btn btn-outline-primary m-2">Ajouter</button>
                            </form>
                        </div>
                    </div>
                </div>
