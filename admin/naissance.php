...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["naissance_submit"])) {
        ...
        if ($conn->query($sqlNaissance) === true) {
            echo "--------------------------------------------------------------ENREGISTREMENT DE NAISSANCE REUSSI !";
        } else {
...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Mode de naissance</th>
            ...
            <!-- Debut Form NAISSANCE -->
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Ajouter une naissance</h6>
                            <form method="POST" action="">
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="nom" class="form-control" id="nomPharm" placeholder="Nom & Prénoms" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="sexe" class="form-control" id="nomPharm" placeholder="Sexe" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="mode" class="form-control" id="nomPharm" placeholder="mode de naissance" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="pere" class="form-control" id="nomPharm" placeholder="Nom du père" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="mere" class="form-control" id="nomPharm" placeholder="Nom de la mère" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="lieu" class="form-control" id="nomPharm" placeholder="Lieu d'habitation de la famille" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="tel" class="form-control" id="nomPharm" placeholder="Numéro" autocomplete="none" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="whatsapp" class="form-control" id="nomPharm" placeholder="Numéro whatsapp" autocomplete="none" >
                                    </div>
                                </div>
                                <button type="submit" name="naissance_submit" class="btn btn-outline-primary m-2">Ajouter</button>
                            </form>
                        </div>
                    </div>
                </div>
