        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="centresante.php" class="nav-item nav-link active"><i class="far fa-hospital me-2"></i>Centres santés</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">CENTRES DE SANTES</h6>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Services offerts</th>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Ajouter un Centre de santé</h6>
                            <form method="POST" action="traitement.php">
                                ...
                                <div class="row mb-3">
                                    <label for="nomPharm" class="col-sm-2 col-form-label">Services offerts</label>
                                    <div class="col-sm-10">
                                        <textarea type="text" class="form-control" id="nomPharm"></textarea>
                                    </div>
                                </div>
