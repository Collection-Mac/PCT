...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["emploi_submit"])) {
        ...
        if ($conn->query($sqlEmploi) === true) {
            echo "--------------------------------------------------------------ENREGISTREMENT D'OFFRE D'EMPLOI REUSSI !";
        } else {
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="emploi.php" class="dropdown-item active">Proposition emploi</a>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">PROPOSITION D'EMPLOI</h6>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Services offrire</th>
                                    <th scope="col">Qualifications/Compétences</th>
                                    <th scope="col">Numéro</th>
                                    <th scope="col">Whatsapp</th>
                                    <th scope="col">Information sur l'offre</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Ajouter une offre</h6>
                            <form method="POST" action="">
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="nome" class="form-control" id="nomPharm" placeholder="Nom & Prénoms" autocomplete="none">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="servicee" class="form-control" id="nomPharm" placeholder="Service à offrire" autocomplete="none">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="qualificatione" class="form-control" id="nomPharm" placeholder="Qualifications/Compétences" autocomplete="none">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="tele" class="form-control" id="nomPharm" placeholder="Numéro de téléphone" autocomplete="none">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="whatsappe" class="form-control" id="nomPharm" placeholder="Numéro whatsapp">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="text" name="commentairee" class="form-control" id="nomPharm" placeholder="Autre Information sur l'offre">
                                    </div>
                                </div>
                                <button type="submit" name="emploi_submit" class="btn btn-outline-primary m-2">Ajouter</button>
                            </form>
                        </div>
                    </div>
                </div>
