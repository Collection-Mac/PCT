...
<head>
    ...
    <title>Centres de santés | Allakro Communauté</title>
</head>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="sante.php" class="nav-item nav-link active">Centres de santés</a>
                </div>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <div class="section-title border-right-0 mb-0" style="width: 100%; background: #430243;">
                            <h4 class="m-0 text-uppercase font-weight-bold" style="color: #fff;">Centres de santés</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <table id="table" class="table table-striped table-bordered table-hover container ">
        <thead>
            <tr role="row">
                <th id="" rowspan="1" colspan="1" style="width: 158.25px;">Centre de santé</th>
                <th id="" rowspan="1" colspan="1" style="width: 158.25px;">Localisation</th>
                <th id="" rowspan="1" colspan="1" style="width: 100.25px;">Contacts</th>
                <th id="" rowspan="1" colspan="1" style="width: 158.25px;">Services offerts</th>
            </tr>
        </thead>
        <tbody>
            <tr role="row" class="odd">
                <td>PHARMACIE DE L'INDENIE</td>
                <td>VOIE PRINCIPALE A COTE DE LA GDE MOSQUEE <br>
                    <strong>Position :</strong> <a href="https://www.google.ci/maps/place/PHARMACIE+INDENIE/@6.7274972,-3.4980941,17z/data=!4m12!1m6!3m5!1s0xfc415fca2cc2c17:0xf878909f2119ee5b!2sPHARMACIE+INDENIE!8m2!3d6.7274919!4d-3.4959054!3m4!1s0xfc415fca2cc2c17:0xf878909f2119ee5b!8m2!3d6.7274919!4d-3.4959054?hl=fr&amp;amp;amp;authuser=1" target="_blank">Google map</a>
                </td>
                <td>M. KOFFI JOSEPH <br>
                    <strong>Contact : </strong>+225 27 35 91 36 04/ 27 35 91 33 82
                </td>
                <td>Cardiologie, Pédiatrie, <br> Gynécologie & Obstétrique</td>
            </tr>
            <tr role="row" class="odd">
                <td>PHARMACIE BELLE FONTAINE (GRANDE)</td>
                <td>QUARTIER HKB <br>
                    <strong>Position :</strong>  Position non precisée
                </td>
                <td>M. ATTOH ANGE EMMANUEL <br>
                    <strong>Contact : </strong>+225 07 69 35 39 09 / 07 08 62 94 83
                </td>
                <td>Cardiologie, Pédiatrie, <br> Gynécologie & Obstétrique</td>
            </tr>
            <tr role="row" class="odd">
