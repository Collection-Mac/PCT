...
<head>
    ...
    <title>Centres de santés | Portail de gestion</title>
</head>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="offre.php" class="nav-item nav-link active">OFFRES D'EMPLOI</a>
                </div>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <div class="section-title border-right-0 mb-0" style="width: 100%; background: #430243;">
                            <h4 class="m-0 text-uppercase font-weight-bold" style="color: #fff;">Offres d'emploi</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <table id="table" class="table table-striped table-bordered table-hover container ">
        <thead>
            <tr role="row">
                <th id="" rowspan="1" colspan="1" style="width: 158.25px;">Ofrres</th>
                <th id="" rowspan="1" colspan="1" style="width: 158.25px;">Description</th>
            </tr>
        </thead>
        <tbody>
            <tr role="row" class="odd">
                <td>Poste Dévéloppeur Web Full Stack</td>
                <td>Maitrise de: <br> PHP, LARAVEL, VueJS, Python</td>
            </tr>
            <tr role="row" class="odd">
                <td>Stage Assistante RHCOM</td>
                <td>Tache:<br>
                    <strong>Rédaction de courrier :</strong>  XXXXxxxxxxxxxx
                </td>
            </tr>
            <tr role="row" class="odd">
                <td>Caissière d'établisement privé</td>
                <td>XXXxxxXXX<br>
